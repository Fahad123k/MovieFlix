...
//! forefully tell the env have must db id
...
const client = new Client()
    ...
    .setPlatform('FahadTech.MovieFlix');
...
export const updateSearchCount = async (query: string, movie: Movie) => {
    ...
    //  crate a new document in Appwrite database ->1 (count to 1) 

    // console.log('Running updatecount search..')
    ...
    try {
        ...
        // check any resukt is come against my search
...
export const getTrendeingMovies = async (): Promise<TrendingMovie[] | undefined> => {
